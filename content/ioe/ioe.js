/**
 * English Master AI - Dedicated IOE Universal Game Solver v2.13.2
...
(function () {
  ...
  console.log("%c[English Master AI v2.13.2] IOE True/False, MCQ & Reading Passage Engine Active!", "color: #10b981; font-weight: bold; font-size: 14px;");
  ...
  function createIOEUI() {
    ...
    ioeRootEl.innerHTML = `
      <div class="ioe-control-pill" id="ioe-pill-toggle">
        ...
        <span class="ioe-pill-title">English Master v2.13.2</span>
